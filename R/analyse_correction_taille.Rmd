...
file <- "\\\\srv-01\\EPTB\\12-PoleMAB\\Socle\\Migrateurs\\poissons\\suivi_pab\\2023\\Concat23_jusqua42849.txt"
...
# ssm[ssm$remarque=="" & ssm$taillepixel >0,"remarque"] <- 'mm5mm'
...
ssmf <- ssm[,c("fichierVideo",
				...
				"taille",
				"remarque")]
dir.create("C:/workspace/passe_bassins/data/2023/")
file <- str_c("C:/workspace/passe_bassins/data/2023/fichiers_traite_2023.SSM")
