...
if (exists("userdistant") & exists("passworddistant") & exists("hostdistant")) {
	...
	pool <- dbPool(
			...
			host =  decrypt_string(hostmercureinternal,mainpass),
...
file <- "\\\\srv-01\\EPTB\\12-PoleMAB\\Socle\\Migrateurs\\poissons\\suivi_pab\\2025\\Concat25_jusqua56499_verif ok 130226.txt"
...
ssmf <- ssm[,c("fichierVideo",
				...
				"taille",
				"remarque")]
dir.create("C:/workspace/passe_bassins/data/2025/")
file <- str_c("C:/workspace/passe_bassins/data/2025/fichiers_traite_2025.SSM")
