-- connexion en localhost � la base test puis au serveur de production
...
-- A FAIRE CONVERTIR FICHIER EN CSV SEPARATEUR ; csv UTF8 pose un probl�me d'encodage
-- LANCER UNE COMMANDE DANS LA CONSOLE (pour pouvoir �crire sur le serveur distant)
-- Connexion
psql -U postgres -h db.mercure.eaux-et-vilaine.bzh bd_contmig_nat_iav
-- COPY avec psql permet d'�crire sur le serveur distant
