...
graph_DF_detail(data_DF, from="08/04/2024")
dev.off()

png(filename=file.path(imgwd,CY,"detail_fonct_passe_2.png"),7,7,units="in",res=300)
graph_DF_detail(data_DF=data_DF, from="10-05-2024", to="19-05-2024")
dev.off()
...
<<report_annual_dicentrarchus, echo=FALSE, eval=TRUE, include=FALSE >>=
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Bilan annuel des migrations
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ra<-new("report_annual")
...
-2m environ (- noir). Le niveau Vilaine (.- bleu) varie peu et reste
...
passe est calculé pour chaque période de 10 minutes (en bas).
}
...
Jusqu'au 12 avril en milieu de journée, la position basse de la vanne amont
(vanne fermée) indique que la passe est fermée.}
...
(\textcolor{jaune_EV}{\rule[-0.2mm]{3mm}{2mm}}) sont visibles
...
StacomiR \col{turquoise_EV}\citep{briand_stacomir_2017}\par
