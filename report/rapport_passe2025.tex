...
Le fonctionnement de la passe en 2025 a été perturbé par les crues et plusieurs
...
période 1996-2025 (Figure \ref{barchart_bmi_lpm}, Tableau
\ref{table_lpm_mois}).
...
\ref{rmi_density_sat}). En 2025, la migration s'est faite principalement
