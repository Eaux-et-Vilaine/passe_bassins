...
\documentclass[11pt,twocolumn,titlepage,twoside]{article}\usepackage[]{graphicx}\usepackage[]{xcolor}
...
Le fonctionnement de la passe en 2025 a été perturbé par la grande crue de
...
\caption{Fonctionnement de la passe en 2025, niveaux Vilaine, mer, sas
...
graphiques sont présentés pour la période 2002-2025 (Figure
...
\caption{Débits de la passe en 2025. Débits produits par l'automate du
...
\caption{Bilan du fonctionnement du dispositif de comptage en 2025.}
...
L'année 2025 a été marquée par des débits de crue très importants au
premier trimestre, et forts en décembre (Figure \ref{fig_debit}).
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2025/fig_debit.png}
\caption{Débits de la Vilaine en 2025. En bleu = débits mesurés au
...
\input{C:/workspace/passe_bassins/table/2025/5_2183_IND_1996to20250108.tex} % table_bilanannuel_mulets
...
\caption{Horaires de migration des mulets en 2025.}
\label{horaires_mulet}
\end{figure}

\input{C:/workspace/passe_bassins/table/2025/5_2183_IND_mensuel.tex}
...
\textcolor{orange_EV}{\num{747}} lamproies marines (Figure \ref{barplot_report_annual_lpm}, Tableau \ref{table_bilanannuel_lpm}) ce qui place l'année au \textcolor{orange_EV}{\num{16}} ème rang sur les
\textcolor{orange_EV}{\num{30}} années de suivi à Arzal.
...
période 1996-2024, à l'exception du mois d'avril. Elles sont proches de
...
\caption{Comparaison de la migration de lamproies marines de 2025 avec la
série interannuelle de données 1996-2024.}
\label{barchart_bmi_lpm}
\end{figure}



\input{C:/workspace/passe_bassins/table/2025/5_2014_11_mensuel.tex} % table bilan annuel lamproies
\input{C:/workspace/passe_bassins/table/2025/5_2014_11_1996to2025.tex} % table bilan lamproies pour l'année


La migration des lamproies marines intervient entre mars et juin (Figure
\ref{rmi_density_lpm}). En 2025, la migration s'est faite essentiellement
...
1402 aloses ont été comptées en
2025 (Figure
\ref{rmi_journalier_ala} et \ref{tx_exploit}, Tableau
\ref{table_bilanannuel_ala}).
Cette migration place l'année 2025 au rang 9
...
\input{C:/workspace/passe_bassins/table/2025/5_2055_11_1996to2025.tex}


\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2025/rmi_journalier_ala.png}
\caption{Comparaison de la migration d'aloses de 2025 avec la série
interannuelle de données 1996-2024.}
...
\caption{Passage des aloses en 2025, par pas de temps de 10 minutes en
...
\input{C:/workspace/passe_bassins/table/2025//2055_IND_11_2016_2025.tex} % tableau avec effectifs mensuels
...
3 saumon a été compté en
2025 (Figure \ref{barplot_report_annual_sat},  Tableau \ref{table_sat_mois}).
Cette migration place l'année 2025 au 18 ème rang
...
\caption{Comparaison de la migration de saumons de 2025 avec la
série interannuelle de données 1996-2024.}
\label{barchart_bmi_sat}
\end{figure}

\input{C:/workspace/passe_bassins/table/2025/5_2220_IND_mensuel.tex} % table bilan annuel

\input{C:/workspace/passe_bassins/table/2025/5_2220_IND_1996to2025.tex} % table bilan pour l'année
...
ensuite, comme c'est le cas en 2025 (Figures \ref{rmi_density_sat} et
...
en 2025 (Figure \ref{barplot_report_annual_trm}). %,  Tableau
%\ref{table_trm_mois}).
\begin{figure}[htpb]
\centering
...
\input{C:/workspace/passe_bassins/table/2025/5_2224_IND_1996to2025.tex}
...
rencontre que des effectifs très faibles d'autres espèces. En 2025, les
...
\caption{Effectif des autres espèces recensées en 2025 dans la passe.
...
\caption{Effectifs mensuels de bars au droit de la vitre en 2025 et
comparaison aux valeurs historiques.}
\label{barchart_bmi_bar}
\end{figure}

\input{C:/workspace/passe_bassins/table/2025/5_2234__1996to2025.tex} % table bilan bars
...
\input{C:/workspace/passe_bassins/table/2025/5_2238__1996to2025.tex} % table bilan silures
...
\textcolor{orange_EV}{\num{51440}} lignes pour l'année 2025. A partir
...
dehors de la gamme [-1m,2.5m].} correspondent à \textcolor{orange_EV}{\num{972}} lignes et des
...
\textcolor{orange_EV}{\num{2}} lignes.
Au final \textcolor{orange_EV}{\num{52}} lignes manquent des données permettant de
...
\textbf{Résumé}\par
 ...
 Ce rapport présente le bilan du suivi de la passe à bassins d'Arzal en
    \textcolor{orange_EV}{\num{2025}}. Il détaille le fonctionnement de la passe, de son système
    ...
    En \textcolor{orange_EV}{\num{2025}},
    \textcolor{orange_EV}{\num{1402}} aloses (\textit{Alosa
    Sp.}),
    \textcolor{orange_EV}{\num{747}} lamproies marines (\textit{Petromyzon
    marinus}),
    \textcolor{orange_EV}{\num{1}} truite de mer (\textit{Salmo trutta trutta}),
    \textcolor{orange_EV}{\num{3}} saumon (\textit{Salmo salar}) et
    \textcolor{orange_EV}{\num{198537}} mulets porcs (\textit{Chelon ramada})
   ...
   \textbf{Abstract}\par
    ...
    \textcolor{orange_EV}{\num{2025}}. It details the operation of the fishway and it's recording video
    device, along with the annual number of the main species crossing the dam in the Vilaine estuary.
    In \textcolor{orange_EV}{\num{2025}},
    \textcolor{orange_EV}{\num{1402}} shads (\textit{Alosa Sp.}),
    \textcolor{orange_EV}{\num{747}} sea lampreys (\textit{Petromyzon marinus}),
    \textcolor{orange_EV}{\num{1}} sea trout (\textit{Salmo trutta trutta}),
    \textcolor{orange_EV}{\num{3}} salmon (\textit{Salmo salar})
    and \textcolor{orange_EV}{\num{198537}} mulets (\textit{Chelon ramada})
...
R version 4.4.3 (2025-02-28 ucrt)\par
\noindent\hrulefill\par
\end{minipage}}
