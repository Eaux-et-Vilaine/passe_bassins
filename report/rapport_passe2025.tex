...
\textcolor{orange_EV}{\num{739}} lamproies marines (Figure \ref{barplot_report_annual_lpm}, Tableau \ref{table_bilanannuel_lpm}) ce qui place l'année au \textcolor{orange_EV}{\num{16}} ème rang sur les
...
1381 aloses ont été comptées en
2025 (Figure
...
0 saumon a été compté en
2025 (Figure \ref{barplot_report_annual_sat},  Tableau \ref{table_sat_mois}).
Cette migration place l'année 2025 au 27 ème rang
...
extrait de la base de données du barrage contient
 lignes 2025. A partir de ce dernier,
...
des valeurs inférieures à -3.5 m NGF.} correspondent à
 lignes, celles du sas aval \footnote{Le dernier
...
dehors de la gamme [-1m,2.5m].} correspondent à  lignes et des
...
[-1.72m,2.5m] correspondant à la course normale de la vanne.} à
 lignes. 
Au final  lignes manquent des données permettant de
...
\textbf{Résumé}\par
 ...
 Ce rapport présente le bilan du suivi de la passe à bassins d'Arzal en
    ...
    \textcolor{orange_EV}{\num{1381}} aloses (\textit{Alosa
    Sp.}), 
    \textcolor{orange_EV}{\num{739}} lamproies marines (\textit{Petromyzon
    marinus}), 
    \textcolor{orange_EV}{\num{0}} truite de mer (\textit{Salmo trutta trutta}),
    \textcolor{orange_EV}{\num{0}} saumon (\textit{Salmo salar}) et
    \textcolor{orange_EV}{\num{119752}} mulets porcs (\textit{Chelon ramada}) 
   ...
   \textbf{Abstract}\par
    ...
    \textcolor{orange_EV}{\num{1381}} shads (\textit{Alosa Sp.}),
    \textcolor{orange_EV}{\num{739}} sea lampreys (\textit{Petromyzon marinus}), 
    \textcolor{orange_EV}{\num{0}} sea trout (\textit{Salmo trutta trutta}),
    \textcolor{orange_EV}{\num{0}} salmon (\textit{Salmo salar}) 
    and \textcolor{orange_EV}{\num{119752}} mulets (\textit{Chelon ramada}) 
