...
Le fonctionnement de la passe en 2024 a été plutôt bon. 
...
plot(bmi,plot.type="barchart", timesplit="mois", year_choice = CY)
...
plot(bmi,plot.type="density",timesplit="semaine", year_choice=CY)
...
plot(bmi, plot.type="seasonal", timesplit="semaine", year_choice =CY, silent= FALSE) 
dev.off()
