...
du barrage d'Arzal, Rapport 2024)}, 
...
\fancyhead[LO,RE]{\slshape \normalsize Rapport passe à bassins 2024}
...
\bigskip
{\titlefont  \LARGE rapport 2024\par }
\vspace{4mm}\noindent
...
Le barrage d'Arzal protège contre les crues 
...
poissons migrateurs par la passe à bassins en 2024
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/fonctionnement_passe.png}
...
En Figure \ref{report_df_fct_2003_2024}, l'analyse des durées mensuelles
...
\ref{report_df_2003_2024}) en mettant juste en avant les périodes où la passe est fonctionnelle
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/debit_passe_comp.png}
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/report_df_fct_2003_2024.png}
\caption{Fonctionnement de la passe de 2003 à 2024, avec les détails par type
de fonctionnement.}
\label{report_df_fct_2003_2024}
\end{figure}%
%
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/report_df_2003_2024.png}
\caption{Fonctionnement de la passe de 2003 à 2024.}
\label{report_df_2003_2024}
\end{figure}%
%
...
(Figure \ref{report_dc_2024}).

\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/report_dc_2024.png} 
\caption{Bilan du fonctionnement du dispositif de comptage en \Sexpr{CY}.}
\label{report_dc_2024}
\end{figure}

\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/report_dc_1998_2024.png} 
\caption{Bilan du fonctionnement du dispositif de comptage de 1998 à 2024.}
\label{report_dc_1998_2024}
\end{figure}
...
#strptime("2024-04-08 08:00:00",tz = "Europe/Paris",format="%Y-%m-%d %H:%M:%S")
# this one will shift 2 hours
#lubridate::with_tz(
#  lubridate::ymd_hms("2024-04-08 08:00:00",tz="GMT"),
#   tzone = "Europe/Paris")
# before 2016 -------------
if (CY <=2015) {
res1 <- res1 %>%
...
data_DF$debit_passe_recalcule[data_DF$debit_passe_recalcule>3.5] <- NA
...
# mais ici j'ai fait des modifications manuelles en sql/traitementç2024
...
png(filename=paste0(imgwdy,"report_df_2003_2024.png"),width=6,height=12, units="in",res=300)
...
png(filename=paste0(imgwdy,"report_df_fct_2003_2024.png"),width=6,height=12, units="in",res=300)
...
#png(filename=paste0(imgwdy,"report_df_2011_2024.png"),width=8,height=12, units="in",res=300)
...
#dev.off()
#
#png(filename=paste0(imgwdy,"report_df_fct_2011_2024.png"),width=8,height=12, units="in",res=300)
...
png(filename=paste0(imgwdy,"report_dc_1998_2024.png"),width=6,height=12, units="in",res=300)
g_report_dc_1 +
...
DBI::dbExecute(req@connection, "INSERT INTO iav.tj_conditionenvironnementale_env (
        ...
        ,env_stm_identifiant
        ,env_org_code
        FROM tj_conditionenvironnementale_env_temp") #2012 (2021) 2309 (2022) 1982 (2024)
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/fig_debit.png} 
...
res <- dbGetQuery(req@connection,glue("SELECT lot_identifiant, lot_commentaires 
            ...
            WHERE (ope_date_debut, ope_date_fin) overlaps ('2007-01-01'::timestamp without time zone, '2024-12-31 23:59:59'::timestamp without time zone)  
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/graphe_taille_mulets.pdf} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/bilan_annuel_mup} 
\caption{Bilan annuel des migrations de mulets au barrage d'Arzal.}
\label{bilan_annuel_mup}
\end{figure}

Les effectifs de mulets de 2024
(N=\Sexpr{format(vvv[["MUP"]][["NCY"]], digits=1, nsmall =0, big.mark="",scientific=FALSE)}) 
sont faibles comparés à ceux de la période 2014-2024 avec des variations entre
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/horaires_mulet} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/bmm_horaires_maree_mup} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.9\linewidth,keepaspectratio]{2024/rmi_journalier_mup.png} 
...
pred <-
    data.frame("date"=
            as.POSIXct(seq(from=as.POSIXct(dmy("01012013")), to = as.POSIXct(dmy("30072024")), by="1 day")))
pred <- fndate(pred)
...
bmi <- calcule(bmi)
#save(bmi,file=str_c(datawd,'bmimup2024.Rdata'))
#load(file=str_c(datawd,'bmi2024.Rdata'))
#str(bmi)
...
mmm <- mmm[,-1]
options(encoding = "UTF-8")
colnames(mmm) <- c("Mois", "Min*", "Moyenne*", "Max*", "N (2024)")
xtmmm <- xtable(mmm,caption="Migrations mensuelles des mulets dans la passe à bassins du barrage d'Arzal. $N$ = nombre, * correspondent à
        la période 1996-2024. min* = minimum mensuel, max* = maximum mensuel, moyenne* = moyenne des effectifs mensuels.",
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barplot_report_annual_lpm.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barchart_bmi_lpm.png} 
...
lamproies marines en France par \citet{legrand_ContrastingTrendsSpecies_2020} qui
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/rmi_density_lpm.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.49\textwidth]{2024/plot_seasonal_lpm.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/size_lpm.png} 
...
%\begin{figure}[htpb]
%\centering
%\includegraphics[width=0.45\textwidth]{2024/bilan_annuel_ala.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/rmi_journalier_ala.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barchart_bmi_ala.png} 
\caption{Comparaison de la migration d'aloses de \Sexpr{CY} avec la série
interannuelle de données 1996-\Sexpr{CY-1}.}
...
comptage pour prendre en compte les déformations de la lentille de la caméra. Ainsi les tailles avant 2019 et 2024
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/size_alose.png}
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.49\textwidth]{2024/plot_seasonal_ala.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/bmm_horaires_maree_ala} 
...
\begin{figure}[pbt]
\centering
\includegraphics[width=0.5\textwidth]{2024/tx_exploit.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.9\linewidth]{2024/preco_diagram.png} 
...
bmi<-calcule(bmi)
save(bmi,file=str_c(datawd,'bmiala2024.Rdata'))
#load(file=str_c(datawd,'bmi2024.Rdata'))
#str(bmi)
####################
...
xtala <- xtable(datmens2,
    caption=str_c("Migrations mensuelles d'aloses par la passe à bassins du barrage d'Arzal entre 2016 et ", CY,
...
dat <- data.frame("annee"=2002:2024,
...
\Sexpr{CY} (Figure \ref{barplot_report_annual_sat},  Tableau \ref{table_bilanannuel_sat}).
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barplot_report_annual_sat.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barchart_bmi_sat.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/rmi_density_sat.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/size_sat.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/barplot_report_annual_trm.png} 
...
%\begin{figure}[htpb]
%\centering
%\includegraphics[width=0.45\textwidth]{2024/barchart_bmi_trm.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/rmi_density_trm.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/size_trm.png} 
...
graphique à la Figure \ref{autres_especes_2000_2024}. 

\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/autres_especes.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/autres_especes_2000_2024.png} 
\caption{Effectif des autres espèces rencontrées dans la passe d'Arzal depuis
2000.}
\label{autres_especes_2000_2024}
\end{figure}


\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/bilan_annuel_sil.png} 
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.45\textwidth]{2024/size_sil.png} 
...
et mulets. L'objectif est de faire ce calcul pour 2024 mais aussi pour les
années précédentes.
...
res0 <- bind_rows(mapply(fn, 2018:2024, SIMPLIFY =FALSE))
...
res2 <- bind_rows(mapply(fn, 2018:2024, SIMPLIFY =FALSE))
...
res3 <- bind_rows(mapply(fn, 2018:2024, SIMPLIFY =FALSE))
...
\begin{figure}[htpb]
\centering
\includegraphics[width=\textwidth]{2024/detail_fonct_passe_2.png}
...
\begin{figure}[htpb]
\centering
\includegraphics[width=0.8\textwidth]{2024/detail_fonct_passe_1.png}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{2024/debit_passe_mesure.png}
\caption{Débit calculé dans la passe en 2024, mesures de l'automate du barrage.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.6\textwidth]{2024/debit_passe_calcul.png}
\caption{Débit recalculé dans la passe en 2024, après correction des valeurs
...
\begin{figure}[hp]
\centering
\includegraphics[width=0.9\textwidth]{2024/report_df_annee.png} 
...
%\begin{figure}[hp]
%\centering
%\includegraphics[width=0.95\textwidth]{2024/report_df_fct_2003_2010.png} 
...
\begin{figure}[hp]
\centering
\includegraphics[width=\textwidth]{2024/bmm_alose.png}
\caption{Bilan de la migration des aloses en 2024. Effectifs journaliers et
...
\begin{figure}[hp]
\centering
\includegraphics[width=\textwidth]{2024/bmm_mulet.png}
\caption{Bilan de la migration des mulets en 2024. Effectifs journaliers et
fonctionnement des dispositifs de franchissement et de comptage.}
\label{bmm_mulet}
\end{figure}
...
\begin{figure}[hp]
\centering
\includegraphics[width=\textwidth]{2024/bmm_lpm.png}
\caption{Bilan de la migration des lamproies marines en 2024. Effectifs
